for (let i = 1; i <= 11; i++) {
    document.getElementById(`id_d${i}`).onclick = function () {
        let d1 = Number(document.getElementById('id_d1').checked);
        ...
        let d5 = Number(document.getElementById('id_d5').checked) * 3;
