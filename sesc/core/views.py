...
def export(request):
    ...
    INFO = {
        ...
        '10 физтех': {
            'd1': models.FizTech.objects.filter(d1=True, attached=True),
            'd2': models.FizTech.objects.filter(d2=True, attached=True),
            'd3': models.FizTech.objects.filter(d3=True, attached=True),
            'd4': models.FizTech.objects.filter(d4=True, attached=True),
            'd5': models.FizTech.objects.filter(d5=True, attached=True),
            'd6': models.FizTech.objects.filter(d6=True, attached=True),
            'd7': models.FizTech.objects.filter(d7=True, attached=True),
            'd8': models.FizTech.objects.filter(d8=True, attached=True),
            'd9': models.FizTech.objects.filter(d9=True, attached=True),
        },
        '10 хим': {
            'd1': models.Him.objects.filter(d1=True, attached=True),
            'd2': models.Him.objects.filter(d2=True, attached=True),
            'd3': models.Him.objects.filter(d3=True, attached=True),
            'd4': models.Him.objects.filter(d4=True, attached=True),
            'd5': models.Him.objects.filter(d5=True, attached=True),
            'd6': models.Him.objects.filter(d6=True, attached=True),
            'd7': models.Him.objects.filter(d7=True, attached=True),
            'd8': models.Him.objects.filter(d8=True, attached=True),
            'd9': models.Him.objects.filter(d9=True, attached=True),
            'd10': models.Him.objects.filter(d10=True, attached=True),
            'd11': models.Him.objects.filter(d11=True, attached=True),
        },
        '10 био': {
            'd1': models.Bio.objects.filter(d1=True, attached=True),
            'd2': models.Bio.objects.filter(d2=True, attached=True),
            'd3': models.Bio.objects.filter(d3=True, attached=True),
            'd4': models.Bio.objects.filter(d4=True, attached=True),
            'd5': models.Bio.objects.filter(d5=True, attached=True),
            'd6': models.Bio.objects.filter(d6=True, attached=True),
            'd7': models.Bio.objects.filter(d7=True, attached=True),
            'd8': models.Bio.objects.filter(d8=True, attached=True),
            'd9': models.Bio.objects.filter(d9=True, attached=True),
            'd10': models.Bio.objects.filter(d10=True, attached=True),
            'd11': models.Bio.objects.filter(d11=True, attached=True),
        },
    }
